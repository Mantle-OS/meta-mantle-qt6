...
SRC_URI += " \
    ${QT6_GIT}/${QT6_GIT_PROJECT}/qtquick3d-assimp.git;name=qtquick3d6-assimp;branch=${ASSIMP_BRANCH};protocol=${QT6_GIT_PROTOCOL};destsuffix=${BB_GIT_DEFAULT_DESTSUFFIX}/src/3rdparty/assimp/src \
    file://0001-Skip-embree-on-mingw.patch \
"

DEPENDS = "qtbase6 qtdeclarative6 qtshadertools6 qtshadertools6-native qtquick3d6-native"

BBCLASSEXTEND = "native nativesdk"

PACKAGECONFIG:class-target ?= "qtquicktimeline6"
PACKAGECONFIG[qtquicktimeline6] = ",,qtquicktimeline6"
...
SRCREV_FORMAT = "qtquick3d6_qtquick3d6-assimp"
