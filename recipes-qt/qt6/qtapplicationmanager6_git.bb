...
DEPENDS += "qtbase6 qtdeclarative6 libyaml libarchive qtapplicationmanager6-native"
DEPENDS:append:class-target = " qthttpserver6"
...
PACKAGECONFIG[multi-process] = "-DFEATURE_am_multi_process=ON, -DFEATURE_am_multi_process=OFF, qtwayland6 qtwayland6-native"
