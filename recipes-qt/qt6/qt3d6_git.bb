...
SRC_URI += " \
    ${QT6_GIT}/${QT6_GIT_PROJECT}/qtquick3d-assimp.git;name=qt3d6-assimp;branch=${ASSIMP_BRANCH};protocol=${QT6_GIT_PROTOCOL};destsuffix=${BB_GIT_DEFAULT_DESTSUFFIX}/src/3rdparty/assimp/src \
"

# Needed for supporting 64bit off_t
CFLAGS:append:libc-musl = " -DIOAPI_NO_64 -D_GNU_SOURCE"

DEPENDS = "qtbase6 qtdeclarative6 qtdeclarative6-native qtshadertools6 qtshadertools6-native"

PACKAGECONFIG[system-assimp] = "-DFEATURE_qt3d_system_assimp=ON,-DQT_FEATURE_qt3d_system_assimp=OFF,assimp"
PACKAGECONFIG[qtgamepad] = ",,qtgamepad"

SRCREV_FORMAT = "qt3d6_qt3d6-assimp"
