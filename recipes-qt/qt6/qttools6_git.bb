...
SRC_URI += " \
    ${QT6_GIT}/playground/qlitehtml.git;name=qttools6-qlitehtml;branch=master;protocol=${QT6_GIT_PROTOCOL};destsuffix=${BB_GIT_DEFAULT_DESTSUFFIX}/src/assistant/qlitehtml \
    git://github.com/litehtml/litehtml.git;name=qttools6-qlitehtml-litehtml;branch=master;destsuffix=${BB_GIT_DEFAULT_DESTSUFFIX}/src/assistant/qlitehtml/src/3rdparty/litehtml;protocol=https \
    file://0002-examples-don-t-track-source-path.patch \
"

DEPENDS += "qtbase6 qtdeclarative6 qttools6-native"
...
SRCREV_FORMAT = "qttools6_qttools6-qlitehtml_qttools6-qlitehtml-litehtml"
